...
def test_bootstrap_is_deterministic_and_order_independent() -> None:
    ...
    assert MODULE.bootstrap_median(values, 75075) == MODULE.bootstrap_median(values[::-1], 75075)


def test_nearest_rank_is_conservative_at_endpoints() -> None:
    assert MODULE.nearest_rank([3.0, 1.0, 2.0], 0.025) == 1.0
    assert MODULE.nearest_rank([3.0, 1.0, 2.0], 0.975) == 3.0
