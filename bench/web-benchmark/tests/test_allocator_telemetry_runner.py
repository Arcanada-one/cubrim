...
def fixture_bundle(*, samples: int = 13, trials: int = 30, largest: int = 4096, auxiliary_ratio: float = 0.25) -> dict:
    ...
    for sample_index in range(samples):
        ...
        for profile in ("static", "dynamic"):
            profiles[profile] = {
                ...
                "frame_sha256": f"frame-{sample_index}-{profile}".ljust(64, "0"),
                "mode": "web",
                "trials": [
                    {
                        "trial_no": trial_no,
                        "roundtrip_exact": True,
                        "decoded_sha256": f"decoded-{sample_index}".ljust(64, "0"),
                        "allocation_count": 4,
                        ...
                        "decoder_retained_peak_bytes": 2304,
        ...
        results.append(
            {
                ...
                "input_bytes": 2048,
                "input_sha256": f"input-{sample_index}".ljust(64, "0"),
    ...
    return {
        ...
        "protocol": {"samples": 13, "profiles": 2, "warmups": 3, "trials": 30, "seed": 75075},
        "provenance": {
            "source_sha": "expected",
            "runner_sha": "runner".ljust(64, "0"),
            "probe_sha": "probe".ljust(64, "0"),
            "binary_sha": "binary".ljust(64, "0"),
            "manifest_sha": "manifest".ljust(64, "0"),
        },
        "results": results,
    }
