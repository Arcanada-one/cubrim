#!/usr/bin/env bash
# Apply the independently reviewed NEW-24 valid-G2 pointer transaction exactly.
set -euo pipefail

readonly EXPECTED_SQL_SHA256=7c7f662ae75aaf23204beb16ea4317353eeafe7728c5780742435a74801b2a64
...
readonly SCRIPT_DIR
readonly SQL_FILE=$SCRIPT_DIR/db-pointer.sql
