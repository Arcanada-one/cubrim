#!/usr/bin/env bash
# Manual recovery wrapper for the exact backed-up NEW-24 row.
set -euo pipefail

readonly EXPECTED_SQL_SHA256=2c9919ac77afebec3d15bf8c029f28d2408ad0de8be9491a9b719abdf77d1032
...
readonly SCRIPT_DIR
readonly SQL_FILE=$SCRIPT_DIR/db-restore.sql
...
[[ $actual_sql_sha == "$EXPECTED_SQL_SHA256" ]] || {
    printf 'reviewed restore SQL hash mismatch: expected %s, got %s\n' \
