...
- **brotli:** brotli 1.2.0
- **timestamp:** 2026-06-18T14:52:42Z

## Time-Series Results

### t4_entropy_context — 2026-06-18T14:52:42Z
...
### t3_entropy — 2026-06-18T14:52:47Z

Config: raw_store_bound=320, b=256, N=minimal, gap_scheme=rle, value_scheme=entropy, use_square_limit=True
...
### t2_rle_codes — 2026-06-18T14:52:54Z
...
### t4_entropy_context → t3_entropy

| Input | T1 CRatio | T2 CRatio | Delta |
|-------|-----------|-----------|-------|
| sparse_clustered | 0.2451 | 0.4570 | +0.2119 |
| dense | 1.0032 | 1.0032 | 0.0000 |
| text | 0.3482 | 0.5679 | +0.2197 |
| log_like | 0.4467 | 0.6207 | +0.1740 |
| binary_mixed | 1.0016 | 0.9581 | -0.0435 |
| random_high | 1.0032 | 1.0032 | 0.0000 |
| sparse_small | 1.0508 | 1.0508 | 0.0000 |

### t4_entropy_context → t2_rle_codes

| Input | T1 CRatio | T2 CRatio | Delta |
|-------|-----------|-----------|-------|
| sparse_clustered | 0.2451 | 0.0869 | -0.1582 |
| dense | 1.0032 | 1.0032 | 0.0000 |
| text | 0.3482 | 1.0008 | +0.6526 |
| log_like | 0.4467 | 1.0008 | +0.5541 |
