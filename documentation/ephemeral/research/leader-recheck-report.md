# leader-recheck Compression Report
...
- **brotli:** brotli 1.1.0
- **timestamp:** 2026-06-23T09:26:52Z

## Time-Series Results

### t1_v1_default — 2026-06-23T09:26:52Z

Config: raw_store_bound=320, b=256, N=minimal, gap_scheme=rle, value_scheme=bwt-entropy, use_square_limit=True

Round-trip (all inputs): **PASS**

| Input | Size | Cubrim | CRatio | Mode | gzip-9 | gRatio | zstd | zRatio | brotli | bRatio | Round-trip |
|-------|------|--------|--------|------|--------|--------|------|--------|--------|--------|------------|
| sparse_clustered | 2048 | 502 | 0.2451 | cube | 154 | 0.0752 | 105 | 0.0513 | 87 | 0.0425 | PASS |
...
| log_like | 16384 | 5178 | 0.3160 | cube | 430 | 0.0262 | 426 | 0.0260 | 379 | 0.0231 | PASS |
| binary_mixed | 8192 | 8205 | 1.0016 | raw | 5288 | 0.6455 | 5238 | 0.6394 | 4803 | 0.5863 | PASS |
...
| block_bound_runs | 65536 | 9011 | 0.1375 | cube | 3072 | 0.0469 | 2795 | 0.0426 | 2188 | 0.0334 | PASS |
