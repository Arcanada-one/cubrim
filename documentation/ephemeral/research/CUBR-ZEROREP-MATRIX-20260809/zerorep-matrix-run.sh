...
OUT=/root/cubr-levers/zerorep-matrix-20260809
...
ZERO_ROOT=/root/cubr-levers/zerorep-matrix-code
...
PIN=0-15
RUNNER_REL=documentation/ephemeral/research/CUBR-ZEROREP-MATRIX-20260809/zerorep-matrix-run.sh
...
self_test() {
 ...
 printf 'SELF_TEST_ONLY: contract, 72/96 structures, rejection controls, and parser cases passed\n'
}
