...
(Reconstructed copy — original lived in the PROBE-NEW14 worktree, which was
deleted by another session mid-probe. This is the exact script that produced
probe-new14-tables.txt.)
